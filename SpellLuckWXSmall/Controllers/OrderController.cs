    ...
    public class OrderController : Controller
    {
        ...
        public string AgreeRefund(string accountID, string orderID)
        {
            try
            {
                ...
                collection.UpdateOne(Builders<AccountModel>.Filter.Eq("OrderList.OrderID", new ObjectId(orderID)), Builders<AccountModel>.Update.Set("OrderList.$.isRefound", true).Set("OrderList.$.OrderStatus", (int)OrderStatusType.FinishOrder));
                return new BaseResponseModel<string>() { StatusCode = (int)ActionParams.code_ok }.ToJson();
